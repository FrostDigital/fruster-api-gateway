...
/**
 * Client used to write metrics to InfluxDB. Once in InfluxDB the data can be crunched
 * and visualized i.e. on dashboards using Grafana.
 *
 * The client will cache data before sending so it is sent in batches for
 * better performance.
 *
