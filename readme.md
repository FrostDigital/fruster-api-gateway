...
The API Gateway includes support for Server-Sent Events (SSE), which allows for real-time server-to-client communication over HTTP. SSE is disabled by default and requires explicit configuration to enable.

For detailed information about the SSE implementation, see [SSE.md](SSE.md).
